...
******************************************************************************/
#include "Source/stdafx.h" /* NULL */
#include "Source/CommandListFactory.h" /* Function declarations */
#include "Source/CommandList.h" /* CommandList and CommandList_Add */
#include "Source/CommandHandlerFunctions.h" /* all Handle___Command functions */
...
CommandList* CreateCommandList()
{
	...
	*/
	...
	/* TODO ADVANCED: create additional commands
